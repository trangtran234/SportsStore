...
namespace SportsStore.UnitTests
{
    ...
    public class PaginationUnitTest
    {
        ...
        public void Can_Filter_Product()
        {
            ...
            Assert.IsTrue(result[0].ProductID == 2 && result[0].Category == "Cat2");
            Assert.IsTrue(result[1].ProductID == 4 && result[1].Category == "Cat2");
        }
        ...
        [TestMethod]
        public void Can_Add_Quanlity_For_Existing_Lines()
        {
            // Arrange - create some test products
            Product p1 = new Product { ProductID = 1, Name = "P1" };
            Product p2 = new Product { ProductID = 2, Name = "P2" };
